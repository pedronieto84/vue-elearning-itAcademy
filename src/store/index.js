  ...
  state: {
    ...
    courses: [
      ...
      },
      {
        ...
        title: "Vue",
        description:
          "Vue.js (commonly referred to as Vue) is an open-source model–view–viewmodel front end JavaScript framework for building user interfaces and single-page applications. It was created by Evan You, and is maintained by him and the rest of the active core team members.",
        imagUrl:
      ...
      },
      {
        ...
        imagUrl:
          "https://upload.wikimedia.org/wikipedia/commons/thumb/4/47/React.svg/539px-React.svg.png",
        route: "5",
        learners: 745,
        tags: [
          {
    ...
    modules: [
      {
        ...
        title: "Module 1",
        description:
          "Description 1  (from Vue store, not from backend or database)",
        imagUrl: "image url",
        route: "1",
      },
      {
        ...
        title: "Module 2",
        description:
          "Description 2  (from Vue store, not from backend or database)",
        imagUrl: "image url",
        route: "2",
      },
    ],
